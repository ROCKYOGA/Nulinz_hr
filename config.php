...
define("URL_ROOT", "https://localhost/nulinz_hr/");

define("SELF", basename($_SERVER['PHP_SELF']));

define("DATE_FORMAT", "d/m/Y H:i:s");

define("ADMIN_TITLE", "Nulinz IT Solutions");
...
$db=new MySqlDb("localhost","root","","nulinz");
$conn = mysqli_connect("localhost", "root", "", "nulinz");
$mysqli = new mysqli("localhost", "root", "", "nulinz");
